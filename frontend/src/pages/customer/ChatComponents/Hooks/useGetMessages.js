...
const useGetMessages = () => {
    const {customer,selectedSeller,messages,setMessages,userDetails} = useContext(GlobalContext);
    const customerId = userDetails._id;
   
    const selectedSellerId = selectedSeller._id;
    console.log(`Customer : ${userDetails.username} selectedSeller : ${selectedSeller}`)
